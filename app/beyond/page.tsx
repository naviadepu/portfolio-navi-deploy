  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#F2F2F2] px-4 pt-24 pb-12 flex flex-col items-center justify-center relative">
        ...
        <h1 className="text-5xl font-extrabold mb-6 handwritten text-center">Beyond Code</h1>
        <p className="text-xl text-gray-700 text-center mb-8 max-w-xl">
        ...
        <div className="w-full max-w-4xl">
          <h2 className="text-2xl font-bold mb-4 handwritten text-center">Startup Journey</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {galleryImages.map((img) => (
              <div key={img.src} className="flex flex-col items-center">
                ...
                />
                <span className="mt-2 text-gray-600 text-sm text-center">{img.alt}</span>
              </div>
            ))}
          </div>
        </div>
